...
class TestFile(unittest.TestCase):
    def setUp(self):
        fromheurist.mock_data.file.single import DETAIL
...
class TestEnum(unittest.TestCase):
    def setUp(self):
        fromheurist.mock_data.enum.single import DETAIL
...
class TestGeo(unittest.TestCase):
    def setUp(self):
        fromheurist.mock_data.geo.single import DETAIL_POINT, DETAIL_POLYGON
...
class TestDate(unittest.TestCase):
    def setUp(self):
        fromheurist.mock_data.date.fuzzy.single import DETAIL as DETAIL_FUZZY
        fromheurist.mock_data.date.simple.single import DETAIL as DETAIL_SIMPLE
...
class TestResource(unittest.TestCase):
    def setUp(self):
        fromheurist.mock_data.resource.single import DETAIL
