...
class TestFile(unittest.TestCase):
    def setUp(self):
        from examples.file.single import DETAIL
...
class TestEnum(unittest.TestCase):
    def setUp(self):
        from examples.enum.single import DETAIL
...
class TestGeo(unittest.TestCase):
    def setUp(self):
        from examples.geo.single import DETAIL_POINT, DETAIL_POLYGON
...
class TestResource(unittest.TestCase):
    def setUp(self):
        from examples.resource.single import DETAIL
