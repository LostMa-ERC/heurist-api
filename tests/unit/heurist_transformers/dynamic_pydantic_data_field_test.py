...
class Resource(BaseCase):
    ...
    def test_validation_alias(self):
        from heurist.examples.resource.single import PYDANTIC_KEY_VALUE
    ...
    def test_serialization_alias(self):
        from heurist.examples.resource.single import ALIAS_KEY_VALUE
...
class Enum(BaseCase):
    ...
    def test_validation_alias(self):
        from heurist.examples.enum.single import PYDANTIC_KEY_VALUE
    ...
    def test_serialization_alias(self):
        from heurist.examples.enum.single import ALIAS_KEY_VALUE
...
class FuzzyDate(BaseCase):
    ...
    def test_validation_alias(self):
        from heurist.examples.date.simple.single import PYDANTIC_KEY_VALUE
    ...
    def test_serialization_alias(self):
        from heurist.examples.date.simple.single import ALIAS_KEY_VALUE
